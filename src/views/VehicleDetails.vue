<template>
    <div class="container mx-auto pt-8">
        <div class="rounded overflow-hidden shadow-lg p-8">
            <div class="mb-8">
                <img class="w-1/4" :src="vehicle.image.path">
            </div>
            <div class="flex">
                ...
                <div class="CarPrices w-1/2 p-8 border-l">
                    ...
                    <router-link
                        class="bg-green text-white font-bold py-3 px-10 rounded mt-2 inline-block"
                        :to="{name: 'reservation'}"
...
export default {
    ...
    computed: {
        ...
        dates() {
            ...
            const price = this.vehicle.price * daysBetween.days
            return {
